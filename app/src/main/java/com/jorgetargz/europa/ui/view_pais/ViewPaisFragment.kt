...
//                    }
    ...
    private fun loadMainActivityObjects() {
        ...
        drawerLayout =
            (activity as MainActivity).findViewById(R.id.drawer_layout) as androidx.drawerlayout.widget.DrawerLayout
    }

    private fun addPaisToDrawerMenu() {
        removePaisFromDrawerMenu()
        val id = View.generateViewId()
        drawerMenu.add(R.id.drawer_group, id, Menu.NONE, nombre).apply {
    ...
    private fun removePaisFromDrawerMenu() {
        drawerMenu.findItemByTitle(nombre)?.let {
            drawerMenu.removeItem(it.itemId)
        }
    }
